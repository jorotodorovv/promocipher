...
const MasterPasswordInput: React.FC<MasterPasswordInputProps> = ({
  ...
  const isFirstTime = !hasExistingSalt;
        ...
        <Card className="text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              ...
              >
                {showPassword ? (
                  <EyeSlashIcon className="w-6 h-6 text-neutral-medium" />
                ) : (
                  <EyeIcon className="w-6 h-6 text-neutral-medium" />
                )}
              </button>
            </div>
              ...
              <div className="p-4 border rounded-lg border-neutral-light dark:border-neutral-dark-stronk">
                ...
                {rememberMe && (
                  <div className="mt-4 pt-4 border-t border-neutral-light dark:border-neutral-dark-stronk">
                    <div className="flex items-start space-x-3">
                      <ExclamationTriangleIcon className="w-7 h-7 text-neutral-dark dark:text-neutral-medium flex-shrink-0" />
            ...
            <Card className="max-w-md w-full">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-accent-error/10 rounded-lg mb-6">
                  <ExclamationTriangleIcon className="w-9 h-9 text-accent-error" />
                </div>
